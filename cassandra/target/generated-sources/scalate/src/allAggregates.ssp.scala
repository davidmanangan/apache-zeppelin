...
object $_scalate_$allAggregates_ssp {
  def $_scalate_$render($_scalate_$_context: _root_.org.fusesource.scalate.RenderContext): Unit = {
    ;{
      ...
      $_scalate_$_context << ( "\n" );
      ;{
        val allAggregates: Map[(UUID, String), Seq[AggregateSummary]] = $_scalate_$_context.attribute("allAggregates")
        ...
        for (        ((ksId,ksName), aggregates) <- allAggregates
          ...
          for (          aggregate <- aggregates
            ...
            $_scalate_$_context << ( "                                        <tr class=\"text-success\">\n                                            <td style=\"text-align:right\">" );
            $_scalate_$_context <<< (             aggregate.name + aggregate.arguments.mkString("(", ", ", ")")
 );
...
class $_scalate_$allAggregates_ssp extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$allAggregates_ssp.$_scalate_$render(context)
}
