...
object $_scalate_$allUDTs_ssp {
  def $_scalate_$render($_scalate_$_context: _root_.org.fusesource.scalate.RenderContext): Unit = {
    ;{
      ...
      $_scalate_$_context << ( "\n" );
      ;{
        val allUDTs: Map[(UUID,String),Seq[String]] = $_scalate_$_context.attribute("allUDTs")
        ...
        for (        ((ksId,ksName), udts) <- allUDTs
          ...
          for (          udt <- udts
            ...
            $_scalate_$_context << ( "                                        <tr class=\"text-warning\"><td style=\"text-align:left\">" );
            $_scalate_$_context <<< (             udt
 );
...
class $_scalate_$allUDTs_ssp extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$allUDTs_ssp.$_scalate_$render(context)
}
