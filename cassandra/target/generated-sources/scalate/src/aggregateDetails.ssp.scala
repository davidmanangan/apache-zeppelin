...
object $_scalate_$aggregateDetails_ssp {
  def $_scalate_$render($_scalate_$_context: _root_.org.fusesource.scalate.RenderContext): Unit = {
    ;{
      ...
      $_scalate_$_context << ( "\n" );
      ;{
        val sameNameAggregateDetails: SameNameAggregateDetails = $_scalate_$_context.attribute("sameNameAggregateDetails")
        ;{
          ...
          for (          aggregate <- sameNameAggregateDetails.aggregates
            ...
            if (withCaption) {
              $_scalate_$_context << ( "\n                <caption><h4 class=\"text-success\"><span class=\"glyphicon glyphicon-retweet\"></span>&nbsp;" );
              $_scalate_$_context <<< (               aggregate.name
 );
...
class $_scalate_$aggregateDetails_ssp extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$aggregateDetails_ssp.$_scalate_$render(context)
}
