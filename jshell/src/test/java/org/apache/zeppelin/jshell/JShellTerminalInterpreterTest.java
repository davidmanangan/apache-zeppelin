...
import org.apache.zeppelin.jshell.terminal.JTerminalSocketTest;
...
import org.apache.zeppelin.jshell.*;
import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertTrue;

public class JShellTerminalInterpreterTest extends BaseInterpreterTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(JShellTerminalInterpreterTest.class);

    private JShellTerminalInterpreter terminal;
    ...
    public void setUp() throws InterpreterException {
        ...
        terminal = new JShellTerminalInterpreter(p);
        terminal.open();
    ...
    public void testInvalidCommand() {
        ...
        try {
            ...
            // Attempt Connect
            session = webSocketContainer.connectToServer(JTerminalSocketTest.class, uri);
            ...
            LOGGER.info(JTerminalSocketTest.ReceivedMsg.toString());
            String msg = JTerminalSocketTest.ReceivedMsg.get(0);
            LOGGER.info(msg);
            ...
            String invalidCmd = String.format("{\"type\":\"TERMINAL_COMMAND\"," +
                    "\"command\":\"invalid_command\r\"}");
            LOGGER.info("send > " + invalidCmd);
            session.getBasicRemote().sendText(invalidCmd);
            Thread.sleep(5000);
            ...
            for (String msg2 : JTerminalSocketTest.ReceivedMsg) {
                boolean find = msg2.contains("symbol:   variable invalid_command");
                if (find) {
    ...
    public void testValidCommand() {
        ...
        try {
            ...
            //String storeVariable = String.format("{\"type\":\"TERMINAL_COMMAND\"," +
            //        "\"command\":\"String reply=\\\"Hi!\\\"\r\"}");
            //LOGGER.info("send variable > " + storeVariable);
            //session.getBasicRemote().sendText(storeVariable);
            //Thread.sleep(5000);
            //for (String msg2 : JTerminalSocketTest.ReceivedMsg) {
            //    LOGGER.info(msg2);
            //}
            //String printVariable = String.format("{\"type\":\"TERMINAL_COMMAND\"," +
            //        "\"command\":\"System.out.print(reply)\r\"}");
            //LOGGER.info("send variable > " + printVariable);
            //session.getBasicRemote().sendText(printVariable);
            //Thread.sleep(5000);
            //for (String msg2 : JTerminalSocketTest.ReceivedMsg) {
            //    LOGGER.info(msg2);
            //}
            ...
            String echoHelloWorldCmd = String.format("{\"type\":\"TERMINAL_COMMAND\"," +
                    "\"command\":\"System.out.print(\\\"hello world!\\\")\r\"}");
            LOGGER.info("send print> " + echoHelloWorldCmd);
