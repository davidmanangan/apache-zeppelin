# Apache Zeppelin (WIP: Adding JShell Interpreter)

***
This project is a personal attempt on adding the JShell Interpeter so that Java statements can be entered like shell scripts in a Zeppelin Notebook.
***
